...
import com.example.lifestylemotivator.R.id.*;

import android.os.AsyncTask;
import android.util.Log;

public class FindWeatherAsyncTask  extends AsyncTask <String, Void, CityForecastBO> {
	...
	public FindWeatherAsyncTask(MainActivity mainActivity) {
		mActivity = mainActivity;
	}

	protected CityForecastBO doInBackground(String... urls) {
    ...
    protected void onPostExecute(CityForecastBO result) {
    	mActivity.setWeatherInfo(result);
    }
